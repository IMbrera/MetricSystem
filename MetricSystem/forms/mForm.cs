...
namespace MetricSystem
{
    public partial class mForm : Form
    {
        ...
        private void mForm_Load(object sender, EventArgs e)
        {
            ...
            System.Media.SoundPlayer AudioMetric;
            AudioMetric = new System.Media.SoundPlayer(Properties.Resources.metricse);
            AudioMetric.Play();
            выбратьФайлToolStripMenuItem.BackColor = Color.OrangeRed;
        ...
        private void metroToggle1_CheckedChanged(object sender, EventArgs e)
        {
         ...
         popup.Image = Properties.Resources._1sGTsxv;
                popup.TitleText = "System Metric";
                popup.ContentText = "Program work in trey now";
                popup.Popup();
                */
                WindowState = FormWindowState.Minimized;
                ShowInTaskbar = false;
                notifyIcon1.Visible = true;
                System.Media.SoundPlayer hideaudio;
                hideaudio = new System.Media.SoundPlayer(Properties.Resources.mix);
                hideaudio.Play();
                notifyIcon1.ShowBalloonTip(1000, "Система метрик", "Программа работает в трее.", ToolTipIcon.Info);
            }
        }
        ...
        private void расчитатьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            #region
            if (richTextBox1.Text == "")
                           MetroFramework.MetroMessageBox.Show(this,"Выберите файл для вычисления Метрики!","Сообщение",MessageBoxButtons.OKCancel,MessageBoxIcon.Warning);
           ...
           var MatchDelete = RegDelete.Matches(AnalysedText);
            ...
            else
            {
                ...
                double E = (D * V); dataGridView1.Rows[8].Cells[2].Value = E;
                double B = (V / 3000); dataGridView1.Rows[9].Cells[2].Value = B;
                double T = (E / 18); dataGridView1.Rows[10].Cells[2].Value = T;
